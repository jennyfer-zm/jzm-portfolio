            ...
            <div className="container">
                <div className="container-inner">
                        ...
                        <div className="col-xl-12 col-lg-12">
                            <SlideUp>
                                <div className="section-title text-center">
                                    ...
                                    <p>Every project tells a story. Here's a collection of work where creativity, strategy, and attention to detail come together to create meaningful experiences.</p>
                                </div>
                            </SlideUp>
                        </div>
                    </div>
                    ...
                    <div className="row project-masonry-active overflow-hidden">
                        {filteredProjects.map(({ category, id, src, title, link }) => <Card key={id} id={id} category={category} src={src} title={title} animationClass={animationClass} link={link}/>)}
