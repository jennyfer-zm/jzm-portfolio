...
<div className="navbar-collapse collapse">
    <ul className="navigation onepage clearfix">
        <li><Link href="/" className="nav-link-click">Home</Link></li>
        <li><Link href="/about" className="nav-link-click">About</Link></li>
        <li><Link href="/works" className="nav-link-click">Works</Link></li>
        <li><Link href="/contact" className="nav-link-click">Contact</Link></li>
    </ul>
</div>
                            </nav>
